import { existe_na_lista_pelo_menos_1_numero_divisivel_por_numero_N, retonar_maior_numero_da_lista, multiplica_numeros_de_uma_lista_entre_si } from "./funcoes_array.mjs"
