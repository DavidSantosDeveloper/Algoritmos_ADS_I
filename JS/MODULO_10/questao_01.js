...
import { criptografaFraseV1 } from './Bibliotecas/funcoes_auxiliares_lista_de_strings.mjs'

function main() {
    // ENTRADA
    let frase = obter_texto('Digite uma frase: ');
    // PROCESSAMENTO
    let frase_criptografada = criptografaFraseV1(frase);
    // SAIDA
    mostrar_texto(`FRASE CRIPTOGRAFADA => ${frase_criptografada}`)
}
main()